...
Version  : 1.0.3
Release  : 1
URL      : https://github.com/clearlinux/abireport/releases/download/v1.0.3/abireport-1.0.3.tar.gz
Source0  : https://github.com/clearlinux/abireport/releases/download/v1.0.3/abireport-1.0.3.tar.gz
...
%prep
%setup -q -n abireport-1.0.3

%build
export LANG=C
export SOURCE_DATE_EPOCH=1486139254
