...
Source0  : https://github.com/clearlinux/abireport/releases/download/v1.0.10/abireport-1.0.10.tar.xz
...
%prep
%setup -q -n abireport-1.0.10
cd %{_builddir}/abireport-1.0.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585243232
...
cp %{_builddir}/abireport-1.0.10/LICENSE %{buildroot}/usr/share/package-licenses/abireport/598f87f072f66e2269dd6919292b2934dbb20492
cp %{_builddir}/abireport-1.0.10/vendor/github.com/inconshreveable/mousetrap/LICENSE %{buildroot}/usr/share/package-licenses/abireport/9174f93c54ad0022bbb9b445480cfb6b4217226a
cp %{_builddir}/abireport-1.0.10/vendor/github.com/spf13/cobra/LICENSE.txt %{buildroot}/usr/share/package-licenses/abireport/c7feacb4667f8c63c89e2eeeb9a913bd3ced8ac2
cp %{_builddir}/abireport-1.0.10/vendor/github.com/spf13/pflag/LICENSE %{buildroot}/usr/share/package-licenses/abireport/b3c86ae465b21f7323059db335158b48187731c7
%make_install
